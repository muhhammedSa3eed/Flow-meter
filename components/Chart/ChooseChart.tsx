...
//           className="space-y-4 bg-red-300"
//         >
...
//           <div className="h-[calc(100vh-150px)] w-full bg-blue-400 !flex-col lg:!flex-row">
//             <ResizablePanelGroup
          ...
          <div className="h-[calc(100vh-150px)] w-full">
            {isLargeScreen ? (
              ...
              <div className="flex flex-col h-full w-full rounded-lg border">
                {/* DatasetSelector and Data/Customize Form */}
                <div className="h-[60vh] sm:h-[50vh] w-full border-b">
                  <ScrollArea className="h-full w-full">
                ...
                {/* ChartDisplay and ResultTable */}
                <div className="h-[40vh] sm:h-[45vh] w-full">
                  <ResizablePanelGroup
                    direction="vertical"
                    className="h-full w-full rounded-lg border"
                  >
