...
export default function DataForm({
                      ...
                      <CommandGroup>
                        {VisualizationTypeData.map((item) => (
                          <CommandItem
                            ...
                            //   const selectedId = Number(currentValue);
                            //   field.onChange(selectedId);
                            //   const selectedLine = VisualizationTypeData.find(
                            //     (i) => i.id === selectedId
                            //   );
  ...
  <div className="flex items-center gap-2">
    {
      IconOptions.find(
        (item) => item.value.toLowerCase() === selectedTypeName.toLowerCase()
      )?.icon
    }
    <Label className="capitalize">{selectedTypeName}</Label>
  </div>
)}
      <Separator /> */}
                ...
                <div className="*:not-first:mt-2">
                  ...
                  <div className="flex items-center gap-2">
                    <MultipleSelector
                      ...
                      creatable
                      onChange={(values) => {
                        const newDimensions = values.map((val) => val.value);
                    ...
                    >
                      ...
                      <PopoverContent className="w-96">
                        ...
                        <div className="flex justify-end gap-2 mt-4">
                          <Button
                            variant="outline"
                            onClick={() => setIsPopoverDimensionsOpen(false)}
                          >
                            Cancel
                          </Button>
                          <Button onClick={handleSaveDimensions}>Save</Button>
                        </div>
                      </PopoverContent>
                    </Popover>
                  </div>
                              ...
                              <div>
                                <Select
                                  ...
                                  onValueChange={(value) => {
                                    ...
                                    setSelectedMetricsColumn(selected || null);
                                  }}
                                >
                                  <SelectTrigger>
                                    <SelectValue placeholder="Select Column(s)" />
