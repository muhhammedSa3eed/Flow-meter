  ...
  return (
    <Form {...form}>
      <form
        ...
        className="space-y-4 h-[1800px] md:h-auto"
      >
        <div className="flex flex-col gap-4 my-3 px-4 sm:px-6">
          <FormField
            control={form.control}
            name="name"
            render={({ field }) => (
              <FormItem className="w-full max-w-md sm:max-w-lg">
                <FormControl>
                  <div className="group relative">
                    <FormLabel
                      htmlFor={id}
                      className="origin-start absolute top-1/2 block -translate-y-1/2 cursor-text px-1 text-sm sm:text-base text-muted-foreground/70 transition-all group-focus-within:pointer-events-none group-focus-within:top-0 group-focus-within:cursor-default group-focus-within:text-xs group-focus-within:font-medium group-focus-within:text-foreground has-[+input:not(:placeholder-shown)]:pointer-events-none has-[+input:not(:placeholder-shown)]:top-0 has-[+input:not(:placeholder-shown)]:cursor-default has-[+input:not(:placeholder-shown)]:text-xs has-[+input:not(:placeholder-shown)]:font-medium has-[+input:not(:placeholder-shown)]:text-foreground"
                    >
                      <span className="inline-flex bg-background px-2">
                        Enter Chart Name
                      </span>
        ...
        <div className="flex flex-col  lg:flex-row h-auto lg:h-[calc(100vh-150px)] w-full gap-4 lg:gap-0">
                        ...
                        >
                          <PopoverTrigger asChild>
                            <Button
                              ...
                              role="combobox"
                              aria-expanded={open}
                              className="bg-background hover:bg-background border-input w-full justify-between px-3 font-normal outline-offset-0 outline-none focus-visible:outline-[3px] text-sm sm:text-base"
                            >
                              {field.value ? (
                                <span className="flex min-w-0 items-center gap-2">
                                  <span className="truncate">
          ...
          <div className="w-full lg:w-1/2 min-w-0">
            <div className="lg:h-full w-full h-[600px]">
              <ResizablePanelGroup
                direction="vertical"
                className="h-full w-full rounded-lg border"
              >
                ...
                <ResizablePanel
                  ...
                  className="min-w-0 "
                >
                  <Tabs defaultValue="tab-1" className="h-[200px] w-full">
                    <TabsList className="h-auto rounded-none border-b bg-transparent p-0">
                      <TabsTrigger
                        value="tab-1"
                        className="data-[state=active]:after:bg-primary relative rounded-none py-2 text-sm sm:text-base after:absolute after:inset-x-0 after:bottom-0 after:h-0.5 data-[state=active]:bg-transparent data-[state=active]:shadow-none"
                      >
                        Result
                      </TabsTrigger>
                      <TabsTrigger
                    ...
                    <TabsContent
                      value="tab-1"
                      className="h-[calc(100%-40px)] min-h-[200px] p-4 overflow-x-auto overflow-y-auto bg-background"
                    >
                      <ResultTable
                        chartDetails={chartDetails}
                        chartData={chartData}
                      ...
                      {!chartData?.data?.length && (
                        <div className="flex items-center justify-center h-full text-sm text-muted-foreground">
                          No results data available. Check dataset or filters.
                        </div>
                      )}
                    </TabsContent>
                    <TabsContent
                    ...
                    >
                      ...
                      {!sampleData?.length && (
                        <div className="flex items-center justify-center h-full text-sm text-muted-foreground">
                          No sample data available. Check dataset connection.
                        </div>
                      )}
                    </TabsContent>
                  </Tabs>
