...
export const ChartSchema = z.object({
  ...
  //     // columnName: z.string().min(1, 'Column is required'),
  ...
  // Row limit
  rowLimit: z.number().optional().nullable(),
  ...
  // .default({})
  // .nullable(),
  // customizeOptions: z.any().optional(),
  customizeOptions: z.any().nullable(),
  // Dataset info (simplified from your response)
  // dataset: z
  //   .object({
  //     id: z.number(),
  //     name: z.string(),
  ...
  //     fieldsAndTypes: z.record(z.string()).optional(),
  //   })
  //   .optional(),

  // Additional fields from response
  displayFields: z.record(z.boolean()).optional(),
});
